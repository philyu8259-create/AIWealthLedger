...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _dictionaries = {
    'zh': {
      ...
      'home.vipUpgrade.title': '升级 AI财富账本会员',
      ...
      'settings.aboutApp.title': '关于 AI财富账本',
      ...
      'settings.export.subject': 'AI财富账本账单导出',
      'settings.export.message': 'AI财富账本账单导出（{start} ~ {end}）',
      ...
      'settings.export.filePrefix': 'AI财富账本',
    ...
    'en': {
      'app.title': 'AI Wealth Ledger',
      'nav.home': 'Home',
      'nav.transactions': 'Entries',
      'nav.reports': 'Reports',
      'nav.analysis': 'AI',
      'nav.settings': 'Settings',
      'welcome.title': 'AI Wealth Ledger',
      ...
      'home.chooseFromLibrary': 'Choose from library',
      ...
      'settings.aboutApp.title': 'About AI Wealth Ledger',
      ...
      'settings.export.subject': 'AI Wealth Ledger export',
      'settings.export.message': 'AI Wealth Ledger export ({start} ~ {end})',
