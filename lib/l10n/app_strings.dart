...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _dictionaries = {
    ...
    'en': {
      'app.title': 'AI Expense Tracker',
      'nav.home': 'Home',
      'nav.transactions': 'Entries',
      'nav.reports': 'Reports',
      'nav.analysis': 'AI',
      'nav.settings': 'Settings',
      'welcome.title': 'AI Expense Tracker',
      ...
      'settings.aboutApp.title': 'About AI Expense Tracker',
      ...
      'settings.export.subject': 'AI Expense Tracker export',
      'settings.export.message': 'AI Expense Tracker export ({start} ~ {end})',
